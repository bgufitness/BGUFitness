...
class CompletedSellerOrders extends StatefulWidget {
  const CompletedSellerOrders({Key? key}) : super(key: key);

  @override
  State<CompletedSellerOrders> createState() => _CompletedSellerOrdersState();
}

class _CompletedSellerOrdersState extends State<CompletedSellerOrders> {
  @override
