...
class GymBookingDetailPage extends StatefulWidget {
  final bookingData;
  final email;
  final vendorId;

  GymBookingDetailPage({this.bookingData, this.email, this.vendorId});

  @override
  State<GymBookingDetailPage> createState() =>
      _GymBookingDetailPageState();
}

class _GymBookingDetailPageState extends State<GymBookingDetailPage> {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Booking ticket:  ${widget.bookingData["orderId"]}",
                    ),
                    Text("End Date:  ${(widget.bookingData["bookingEnds"]as Timestamp).toDate()}"),
                    Text(
